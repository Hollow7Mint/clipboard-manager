"""Clipboard Manager — helpers for pin payloads."""
...
def parse_pins(payload: str) -> List[Dict[str, Any]]:
    """Parse a JSON array of Pin payloads."""
...
def search_pin_to_str(
    record: Dict[str, Any], indent: Optional[int] = None
) -> str:
    """Convenience wrapper — serialise a Pin to a JSON string."""
    if indent is None:
